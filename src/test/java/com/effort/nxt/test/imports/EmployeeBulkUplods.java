...
public class EmployeeBulkUplods extends BaseAutomationTest{
	...
	public void employeeCustomerTypeMapping() throws InterruptedException {
		...
		String actualStatusMsg=this.importpage.importEmployeeCustomerTypeMapping(importProp.getProperty("empCustomer"),importSheetPath);
	...
	public void employeeRoutePlanMapping() throws InterruptedException {
		...
		String actualStatusMsg=this.importpage.importRoutePlanMapping(importProp.getProperty("empRouteMapping"),importSheetPath);
	...
	public void employeeRouteAssignment() throws InterruptedException {
		...
		String actualStatusMsg=this.importpage.importRouteAssignment(importProp.getProperty("empRoutePlanAssignment"),importSheetPath);
	...
	public void employeeLeaveBalance() throws InterruptedException {
		...
		String actualStatusMsg=this.importpage.importEmployeeLeaveBalance(importProp.getProperty("empLeaveBalance"),importSheetPath);
	...
	public void employeeIDUpdate() throws InterruptedException {
		...
		String actualStatusMsg=this.importpage.importEmployeeIDUpdate(importProp.getProperty("empIdUpdate"),importSheetPath);
	...
	public void employeeWorkReassignment() throws InterruptedException {
		...
		String actualStatusMsg=this.importpage.importEmployeeWorkReassignment(importProp.getProperty("empBulkWorkReassignment"),importSheetPath,importProp.getProperty("workSpecName"));
