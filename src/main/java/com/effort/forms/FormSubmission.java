...
public class FormSubmission extends BaseAutomationPage {
	...
	public void uploadAudio(String filepath) {
		logger.info("Starting of uploadAudio method");

		this.fileChoose.get(0).sendKeys(filepath);

		logger.info("Ending of uploadAudio method");
	}

	public void uploadDocument(String filepath) {
		logger.info("Starting of uploadDocument method");

		this.fileChoose.get(1).sendKeys(filepath);

		logger.info("Ending of uploadDocument method");
	}

	public void uploadImage(String filepath) {
		logger.info("Starting of uploadImage method");

		this.fileChoose.get(2).sendKeys(filepath);

		logger.info("Ending of uploadImage method");
	}

	public void uploadVideo(String filepath) {
		logger.info("Starting of uploadVideo method");

		this.fileChoose.get(3).sendKeys(filepath);

		logger.info("Ending of uploadVideo method");
	}
	...
	public void audioData() throws IOException, InterruptedException {
		...
		// String pathExeFile=System.getProperty("user.dir")+
		// "\\Autoit\\AudioScript.exe";
