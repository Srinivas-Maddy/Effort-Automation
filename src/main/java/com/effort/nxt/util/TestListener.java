...
public class TestListener implements ITestListener {
	...
	public void onFinish(ITestContext context) {
		...
		EmailSender.sendEmail("srinivas.maddy@spoors.in,saikiran.devarakonda@spoors.in,sirisha.dande@spoors.in,komal.jidage@spoors.in,venkatesh.avula@spoors.in", "Web Automation Sanity Report",
